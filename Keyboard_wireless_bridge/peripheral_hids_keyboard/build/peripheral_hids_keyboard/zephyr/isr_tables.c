...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x13695, (ISR)0x221df}, /* 42 */
	{(const void *)0x148a1, (ISR)0x221df}, /* 43 */
